...
/**
 * This is a good pattern to remember for all the union find questions.
 *
 ...
 *
 * Copied code from https://youtu.be/ID00PMy0-vE.
 */

public class DisjointSet_Template {
    ...
    public static void main(String args[]) {
        DisjointSet_Template ds = new DisjointSet_Template();
        ds.makeSet(1);
        ds.makeSet(2);
        ds.makeSet(3);
        ds.makeSet(4);
